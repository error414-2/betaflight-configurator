...
var TRANSPONDER = {};
TRANSPONDER.supported = true;
TRANSPONDER.data = [0,1,2,3,4,5,6];
TRANSPONDER.type = [0];
        ...
        if (TABS.transponder.available) {
            ...
            $('a.save').click(function () {
                ...
                function save_transponder_type() {
                    MSP.send_message(MSPCodes.MSP_SET_TRANSPONDER_TYPE, MSP.crunch(MSPCodes.MSP_SET_TRANSPONDER_TYPE), false, save_transponder_data);
                }

                function save_transponder_data() {
                    MSP.send_message(MSPCodes.MSP_SET_TRANSPONDER_CONFIG, MSP.crunch(MSPCodes.MSP_SET_TRANSPONDER_CONFIG), false, save_to_eeprom);
                }
